    ...
    <section className="py-16 bg-primary">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-lg text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
          Ready to get started? <strong>Join MaltaGuns</strong> today! Create an
          account to buy, sell, and connect with other firearm enthusiasts. Be
          part of our <strong>community</strong>!
        </p>
