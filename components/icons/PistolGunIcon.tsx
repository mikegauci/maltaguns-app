...
type PistolGunIconProps = {
  className?: string
}

export function PistolGunIcon({ className }: PistolGunIconProps) {
  return (
    <svg
      viewBox="0 0 759 591.2"
    ...
    >
      ...
      <path
        ...
        strokeMiterlimit={10}
        strokeWidth={16}
        d="M296.6,150.2h-140.6c-8.7,0-19.2,1.6-26.8-3.6-14.3-9.8-5.5-29.5,9.9-31.8,32.2-.7,64.6,0,96.9,0h38c7.1,0,14.5-.4,21.6.2,22.1,1.8,22.8,31.3,1.1,35.2Z"
      />
    </svg>
  )
}
