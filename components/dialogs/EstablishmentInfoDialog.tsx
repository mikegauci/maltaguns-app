    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        ...
        <div className="space-y-4 py-4 text-sm">
          ...
          <p>
            By creating your business profile, you&apos;ll benefit from increased
            visibility, access to a niche customer base, and the ability to
            publish blog posts that highlight your expertise and services.
          </p>
          <p>
            Join Malta&apos;s premier firearms marketplace today and connect with
            potential customers who are passionate about shooting sports and
            firearms safety!
          </p>
        </div>
      </DialogContent>
