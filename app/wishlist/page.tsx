...
export default function WishlistPage() {
  ...
  async function handleRemoveItem(listingId: string) {
    setIsRemoving(true);
    try {
      const response = await fetch(`/api/wishlist/remove?listingId=${listingId}`, {
        method: "DELETE",
      });
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <CardDescription className="text-lg max-w-md mx-auto">
                  Start browsing the marketplace to save items you're interested in
                </CardDescription>
              </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      <span className="font-semibold text-primary">
                        {formatPrice(
                          wishlistItems.reduce((sum, item) => sum + item.listings.price, 0)
                        )}
                      </span>
                    </p>
                  </div>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <Badge variant="secondary" className="text-xs">
                        {getCategoryLabel(item.listings.category, item.listings.type)}
                      </Badge>
                    </div>
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      {item.listings.type === "firearms" && item.listings.calibre && (
