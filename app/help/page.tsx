              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="border rounded-lg p-5 hover:border-primary transition-colors">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Discover how to search, filter, and find the best listings
                      on our marketplace.
                    </p>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="what-is-maltaguns">
                    ...
                    <AccordionContent>
                      ...
                      and selling firearms and accessories, a directory of local
                      retailers, information about events, and expert articles
                      about firearms and shooting sports.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="membership-cost">
                    ...
                    <AccordionContent>
                      Basic membership to MaltaGuns is completely free. You can
                      browse listings, read articles, and view events without
                      any cost. We do offer premium features for sellers, which
                      come with a small fee to help support our platform.
                    </AccordionContent>
                  </AccordionItem>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="how-to-sell">
                    ...
                    <AccordionContent>
                      ...
                      verify your seller status. Once approved, you can click on
                      "Post Listing" from your dashboard or the marketplace
                      page. Fill out the listing details with accurate
                      information and photos of your item. Your listing will be
                  ...
                  <AccordionItem value="seller-verification">
                    ...
                    <AccordionContent>
                      ...
                      license or dealer permit. Our team reviews these documents
                      to ensure compliance with Maltese laws. This helps
                  ...
                  <AccordionItem value="buying-fees">
                    ...
                    <AccordionContent>
                      ...
                      marketplace. We only charge a small commission to sellers
                      for successful transactions, which helps us maintain the
                      platform and provide a quality service.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="featured-listings">
                    ...
                    <AccordionContent>
                      Featured listings receive premium placement at the top of
                      search results and on the homepage. To feature your
                      listing, navigate to your active listing, click "Promote
                      Listing," and select a featuring duration. Featuring a
                      listing costs €5 for 7 days, €8 for 14 days, or €12 for 30
                      days.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              ...
              <CardContent>
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-100 dark:border-blue-800 mb-6">
                  <p className="text-sm text-blue-700 dark:text-blue-400">
                    <strong>Disclaimer:</strong> This information is provided as
                    a general guide only and should not be considered legal
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="license-requirements">
                    ...
                    <AccordionContent>
                      In Malta, you need a Category B license for most firearms,
                      which requires completing a firearms safety course,
                      passing a background check, and demonstrating a legitimate
                      reason for ownership, such as sport shooting or
                      collecting. Different license types exist for different
                      weapon categories, and requirements vary accordingly.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="buying-process">
                    ...
                    <AccordionContent>
                      ...
                      Commissioner. Once you have your license, you can purchase
                      from a registered dealer or private seller. The
                      transaction must be registered with the authorities, and
                      the weapon must be transported safely and stored securely
                  ...
                  <AccordionItem value="storage-requirements">
                    ...
                    <AccordionContent>
                      Maltese law requires firearms to be stored in an approved
                      gun safe that complies with specific security standards.
                      Ammunition must be stored separately from firearms. Your
                      storage arrangements may be inspected by the police as
                      part of the licensing process or during random checks.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="transport-regulations">
                    ...
                    <AccordionContent>
                      When transporting firearms in Malta, they must be unloaded
                      and secured in a locked case or container. Ammunition
                      should be transported separately. You must carry your
                      firearms license with you, and transport should be direct
                      between authorized locations (e.g., residence, shooting
                      range, gunsmith).
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              ...
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="delete-account">
                    ...
                    <AccordionContent>
                      Yes, you can delete your account by going to your Profile
                      settings, navigating to the "Account" tab, and selecting
                      "Delete Account." Please note that this action is
                      permanent and will remove all your data from our system,
                      including your listings and messages.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="email-notifications">
                    ...
                    <AccordionContent>
                      ...
                      Profile settings under the "Notifications" tab. From
                      there, you can choose which types of emails you'd like to
                      receive, such as new listing alerts, messages, and
                      platform updates.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="update-profile">
                    ...
                    <AccordionContent>
                      ...
                      settings by clicking on your profile icon in the top right
                      corner. From there, you can edit your personal details,
                      contact information, and profile picture. Remember to
              ...
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="login-issues">
                    ...
                    <AccordionContent>
                      ...
                      <ol className="list-decimal pl-5 space-y-2">
                        <li>
                          Check that you're using the correct email address and
                          password
                        </li>
                        <li>
                  ...
                  <AccordionItem value="listing-not-visible">
                    ...
                    <AccordionContent>
                      <p className="mb-3">
                        If your listing isn't appearing, consider these reasons:
                      </p>
                      <ul className="list-disc pl-5 space-y-2">
                        <li>
                      ...
                      <p className="mt-3">
                        If none of these resolve your issue, please contact our
                        support team.
                      </p>
                    </AccordionContent>
                  </AccordionItem>
