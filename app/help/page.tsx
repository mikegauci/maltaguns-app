...
import { Mail, Phone, BookOpen, HelpCircle, AlertCircle, FileText } from "lucide-react"
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div className="border rounded-lg p-5 hover:border-primary transition-colors">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        Learn how to set up your MaltaGuns account and customize your profile.
                      </p>
                    ...
                    <div className="border rounded-lg p-5 hover:border-primary transition-colors">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="font-semibold">Browsing the Marketplace</h3>
                      </div>
                      <p className="text-sm text-muted-foreground mb-4">
                        Discover how to search, filter, and find the best listings on our marketplace.
                      </p>
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionItem value="community-guidelines">
                      ...
                      <AccordionContent>
                        Our community guidelines promote respectful interaction, legal compliance, and safety. We prohibit harassment, illegal activity, and misrepresentation. All firearms listings must comply with Maltese law, and sellers must have proper licensing. For full details, please refer to our <a href="/terms" className="text-primary hover:underline">Terms of Service</a>.
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                </CardContent>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div className="border rounded-lg p-5 hover:border-primary transition-colors">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        Step-by-step guide on how to create effective listings that sell quickly.
                      </p>
                    ...
                    <div className="border rounded-lg p-5 hover:border-primary transition-colors">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        Learn how to conduct safe and legal transactions through our platform.
                      </p>
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionItem value="featured-listings">
                      <AccordionTrigger>How do featured listings work?</AccordionTrigger>
                      <AccordionContent>
                        Featured listings receive premium placement at the top of search results and on the homepage. To feature your listing, navigate to your active listing, click "Promote Listing," and select a featuring duration. Featuring a listing costs €5 for 7 days, €8 for 14 days, or €12 for 30 days.
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                </CardContent>
                ...
                <CardContent>
                  <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-100 dark:border-blue-800 mb-6">
                    <p className="text-sm text-blue-700 dark:text-blue-400">
                      <strong>Disclaimer:</strong> This information is provided as a general guide only and should not be considered legal advice. Always consult with local authorities or a legal professional for the most current and accurate information regarding firearms regulations.
                    </p>
                  </div>
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionItem value="transport-regulations">
                      <AccordionTrigger>How should I transport my firearms?</AccordionTrigger>
                      <AccordionContent>
                        When transporting firearms in Malta, they must be unloaded and secured in a locked case or container. Ammunition should be transported separately. You must carry your firearms license with you, and transport should be direct between authorized locations (e.g., residence, shooting range, gunsmith).
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                </CardContent>
                ...
                <CardContent>
                  <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionItem value="update-profile">
                      ...
                      <AccordionContent>
                        To update your profile information, go to your Profile settings by clicking on your profile icon in the top right corner. From there, you can edit your personal details, contact information, and profile picture. Remember to click "Save Changes" when you're done.
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                </CardContent>
            ...
            <TabsContent value="troubleshooting" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Solutions for common issues on MaltaGuns</CardDescription>
                </CardHeader>
                <CardContent>
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="login-issues">
                      ...
                      <AccordionContent>
                        ...
                        <ol className="list-decimal pl-5 space-y-2">
                          ...
                          <li>If you still can't log in, contact our support team for assistance</li>
                        </ol>
                      </AccordionContent>
                    </AccordionItem>

                    <AccordionItem value="image-upload">
                      <AccordionTrigger>I'm having trouble uploading images</AccordionTrigger>
                      <AccordionContent>
                        <p className="mb-3">If you're experiencing issues uploading images, check the following:</p>
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Make sure your image is in JPG, PNG, or WebP format</li>
                    ...
                    <AccordionItem value="payment-issues">
                      <AccordionTrigger>My payment for a featured listing failed</AccordionTrigger>
                      <AccordionContent>
                        <p className="mb-3">If your payment for a featured listing failed, try these solutions:</p>
                        <ol className="list-decimal pl-5 space-y-2">
                          <li>Check that your payment card has sufficient funds</li>
                          <li>Verify that your card details are entered correctly</li>
                          <li>Ensure your card isn't expired or blocked for online transactions</li>
                          <li>Try a different payment method if available</li>
                          <li>Wait a few minutes and try again, as the issue might be temporary</li>
                    ...
                    <AccordionItem value="listing-not-visible">
                      <AccordionTrigger>My listing isn't showing up</AccordionTrigger>
                      <AccordionContent>
                        <p className="mb-3">If your listing isn't appearing, consider these reasons:</p>
                        <ul className="list-disc pl-5 space-y-2">
                          <li>New listings require approval and may take up to 24 hours to appear</li>
                          <li>Your listing might have been rejected for policy violations (check your email)</li>
                          <li>Your seller verification might be pending or incomplete</li>
                          <li>The listing might have expired (listings are active for 30 days)</li>
                          <li>There might be a technical issue (try refreshing or clearing cache)</li>
                        </ul>
                        <p className="mt-3">If none of these resolve your issue, please contact our support team.</p>
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                </CardContent>
          ...
          <div className="mt-12 mb-12">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Additional support materials to help you use MaltaGuns</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Complete documentation for using MaltaGuns</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="bg-primary/10 p-2 rounded-full">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Get help from other MaltaGuns members</p>
                    </div>
                  </div>
                </div>
              </CardContent>
