...
export default function EditRangePage({
      ...
      try {
        ...
        if (rangeError || !range) {
          ...
          toast({
            ...
            description:
              "The shooting range you're trying to edit doesn't exist.",
            variant: 'destructive',
          })
        ...
        if (range.owner_id !== session.user.id) {
          toast({
            title: 'Unauthorized',
            description:
              "You don't have permission to edit this shooting range.",
            variant: 'destructive',
          })
  ...
  async function handleLogoUpload(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      const {
        data: { publicUrl },
      } = supabase.storage.from('ranges').getPublicUrl(filePath)
  ...
  async function onSubmit(data: RangeForm) {
    try {
      ...
      toast({
        title: 'Range updated',
        description:
          'Your shooting range profile has been updated successfully.',
      })
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="Enter your range address"
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
