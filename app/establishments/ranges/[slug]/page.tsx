...
export default async function RangePage(props: {
  params: Promise<{ slug: string }>
}) {
  const params = await props.params
  await headers()
  ...
  return (
    <>
      <EstablishmentJsonLd establishment={establishment} type="ranges" />
      <EstablishmentClient establishment={establishment} type="ranges" />
    </>
  )
}
