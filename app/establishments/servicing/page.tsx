...
const AUTHORIZED_SERVICING_CREATORS = [
  ...
  useEffect(() => {
    async function fetchServicingProviders() {
      try {
        ...
        if (session?.user) {
          setIsAuthorized(AUTHORIZED_SERVICING_CREATORS.includes(session.user.id))
        }
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            Find firearms repair and maintenance services across Malta
          </p>
        </div>
        ...
        {isAuthorized && (
          <div className="flex justify-end">
            <Link href="/establishments/servicing/create">
              <Button>
