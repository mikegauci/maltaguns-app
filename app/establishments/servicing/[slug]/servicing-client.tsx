...
export default function ServicingClient({ servicing }: { servicing: Servicing }) {
    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="mb-6 flex items-center justify-between">
          <Button
            variant="ghost"
            onClick={() => router.push("/establishments/servicing")}
          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                <h1 className="text-3xl font-bold mb-4">{servicing.business_name}</h1>
                ...
                <div className="space-y-2 mb-4">
                  ...
                  {servicing.phone && (
                    <div className="flex items-center gap-2">
                      ...
                      <a href={`tel:${servicing.phone}`} className="hover:underline">
                        {servicing.phone}
                      </a>
                    </div>
                  )}
                  {servicing.email && (
                    <div className="flex items-center gap-2">
                      ...
                      <a href={`mailto:${servicing.email}`} className="hover:underline">
                        {servicing.email}
                      </a>
                    </div>
                  )}
