...
export async function POST(request: Request) {
  try {
    ...
    console.log("[ADMIN DELETE API] Admin attempting to delete listing:", listingId);
    ...
    if (featuredError) {
      console.error("[ADMIN DELETE API] Error removing from featured listings:", featuredError);
    ...
    if (savedError) {
      console.error("[ADMIN DELETE API] Error removing from saved listings:", savedError);
      // Continue despite this error
    }
    ...
    if (reportsError) {
      console.error("[ADMIN DELETE API] Error deleting listing reports:", reportsError);
      // Continue despite this error
    }
    ...
    if (messagesError) {
      console.error("[ADMIN DELETE API] Error deleting messages:", messagesError);
      // Continue despite this error
    }
