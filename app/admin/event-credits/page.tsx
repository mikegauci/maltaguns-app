...
function EventCreditsPageComponent() {
  ...
  const [selectedEventCredit, setSelectedEventCredit] = useState<EventCredit | null>(null);
  ...
  const fetchData = async () => {
    try {
      ...
      setError(
        error instanceof Error ? error.message : "Failed to fetch event credits data"
      );
      toast({
        title: "Error",
        description:
